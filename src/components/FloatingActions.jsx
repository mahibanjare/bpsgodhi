...
import { telPhone, waPhone } from '../siteConfig'
...
export default function FloatingActions() {
  ...
  return (
    <div style={{
      ...
      <a
        href={`https://wa.me/${waPhone(phone)}?text=Hello%20Bright%20Public%20School%2C%20I%20would%20like%20to%20know%20about%20admissions.`}
      ...
      <a
        href={`tel:${telPhone(phone)}`} aria-label="Call the school" title="Call us"
